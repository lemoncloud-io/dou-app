...
- (shared,web,desktop-web) prepare a picked image for where it is going
...
- (web-ui-kit) toggle a collapsible section from its whole header row, not just the chevron
