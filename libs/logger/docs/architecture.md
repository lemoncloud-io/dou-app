...
- **유닛** (전부 통과 상태):
    ...
    - `libs/bridges`: [setupBridgeLogger.spec.ts](../../bridges/src/logger/setupBridgeLogger.spec.ts) (timestamp·source 전송), [appLogInfoCodec.spec.ts](../../bridges/src/logger/appLogInfoCodec.spec.ts) (앱 로그 정보 인코딩)
