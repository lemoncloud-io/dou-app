import { ingestLogEntry, logBuffer, logger } from './logger';
import { attachLogPersistence, DEFAULT_ERROR_FLUSH_MIN_INTERVAL_MS, DEFAULT_PERSIST_DEBOUNCE_MS } from './persistence';
import type { LogEntry, LogPersistence } from './index';
