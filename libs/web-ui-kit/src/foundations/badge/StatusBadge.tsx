...
export interface StatusBadgeProps {
    label: string;
    /**
     * owner = room owner (accent), pending = invite pending (muted), mine = MY (dark),
     * expired = invite expired/declined (muted — relay 1:1 invite rows, ADR-0089. The backend has no
...
/**
 * Status role pill preset — the Figma tags (room owner / invite pending / MY): a small solid
