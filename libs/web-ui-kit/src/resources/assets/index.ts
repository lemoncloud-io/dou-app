...
// Figma "DoU_Character+Logo" (3769:34384) — the relay default place (DoU Home) stands for the service
...
// Figma "Icon/My Cloud/My Cloud" — the cloud-promo banner and the cloud guide hero share it.
