...
export interface ChatRoomHeaderProps {
     ...
     * `group` (1–n participants) = room name only, centered in the title zone.
     */
    kind?: 'direct' | 'group';
    /** Room / peer title. */
    title?: string;
    ...
    onBack?: () => void;
    /** Overflow (⋯) handler; omit to hide the button. */
    onMore?: () => void;
 ...
 *  - `group`  (1–n): room name only, centered in the title zone.
 * Side slots reserve equal width so the title zone stays balanced.
 */
export const ChatRoomHeader = ({
    ...
    return (
        ...
        >
            ...
            <div className={SLOT}>
                {onMore && (
                    <button type="button" onClick={onMore} aria-label={moreLabel} className={SLOT}>
