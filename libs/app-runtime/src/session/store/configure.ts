 ...
 * passivity rule (ADR-0070 Decision 1 rule 1) holds as written: `store/**` imports no env, no transport,
 ...
 * ADR-0070 Step 5 named now owns it, which is what makes the boot visible in each app's entry point.
 *
