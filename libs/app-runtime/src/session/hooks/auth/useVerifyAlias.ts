 ...
 * broke" and not which leg of which flow — and "the code never arrived" and "I entered the code and
 * it still didn't work" are different bugs. The address, the code and the password are never
 * recorded (ADR-0099).
 */
