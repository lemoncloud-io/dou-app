...
| [data/](./data/README.md)               | repository / local·remote data source 조립                                   | [cache-storage-routing.md](./data/cache-storage-routing.md) — 캐시 타입별 저장소 라우팅(ADR-0051) · [invite-cloud-durability.md](./data/invite-cloud-durability.md) — 초대클라우드 마이그레이션·복구 · [context-design.md](./data/context-design.md) — 전역/요청 context 분리 설계 |
