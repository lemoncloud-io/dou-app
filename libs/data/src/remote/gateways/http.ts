 ...
 * longer has them (ADR-0070 decision 2, `gateways/refreshAbsence.spec.ts`).
 */
 ...
 * rest (ADR-0036: every data call goes through a repository). Both methods are taken: unlike the OAuth
