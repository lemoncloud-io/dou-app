...
export class PlaceRepository extends BaseRepository implements IPlaceRepository {
    constructor(
     ...
     * ChannelRepository.refreshList idiom). `protectedId` shields a just-created place whose row
