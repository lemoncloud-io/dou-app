...
/**
 * Builds the relay refresh signature expected by the backend auth contract.
 */
...
/**
 * Signs a cloud API request with the delegated AWS credentials stored for the active cloud session.
 */
