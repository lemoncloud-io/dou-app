...
/** Persists after clearCachedInitData() so downstream effects know cache was used */
...
/** Returns true when meaningful cached data exists OR was already consumed this session */
...
/** Clear injected cache after consumption to free memory */
