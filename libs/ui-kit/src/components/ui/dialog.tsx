...
const dialogVariants = {
    ...
    'slide-up':
        'inset-0 pt-safe-top pb-safe-bottom pl-safe-left pr-safe-right w-full border-0 data-[state=closed]:slide-out-to-bottom-full data-[state=open]:slide-in-from-bottom-full duration-300',
};
