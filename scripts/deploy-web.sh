...
DEV_DISTRIBUTION_ID="E17WR3OJTYI3VZ"        # TODO: Update with actual CloudFront distribution ID
PROD_DISTRIBUTION_ID="E3BMO7TM6ALL5A"       # TODO: Update with actual CloudFront distribution ID
