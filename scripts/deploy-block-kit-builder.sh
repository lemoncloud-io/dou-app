...
load_deploy_config() {
    BUCKET_NAME="${BLOCK_KIT_BUILDER_S3_BUCKET:?'BLOCK_KIT_BUILDER_S3_BUCKET environment variable is required'}"
    DEV_DISTRIBUTION_ID="${BLOCK_KIT_BUILDER_CF_DEV_DISTRIBUTION_ID:-}"
    PROD_DISTRIBUTION_ID="${BLOCK_KIT_BUILDER_CF_PROD_DISTRIBUTION_ID:-}"
}
