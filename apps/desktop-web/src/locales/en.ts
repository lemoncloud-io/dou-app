...
export const en = {
    ...
    'auth.invite.submit': 'Join workspace',
    ...
    'welcome.guestNote': 'Starts a guest account on this device only.',
    ...
    'chat.thread.composerPlaceholder': 'Reply in thread',
    ...
    'saved.emptyHint': "Open a message's More actions menu and choose Save for later.",
    'saved.deviceLocal': 'Saved on this device only.',
    'saved.otherPlace': 'Another place',
    ...
    'chat.empty.pick.title': 'Pick a conversation',
    'chat.empty.pick.hint': 'Choose a channel from the sidebar, or press {{mod}}K to jump to one.',
    'chat.empty.create.title': 'No channels here yet',
    'chat.empty.create.hint': 'Create the first channel in this place and invite people to it.',
    'chat.empty.create.action': 'Create channel',
    'chat.empty.join.title': 'Nothing to read yet',
    'chat.empty.join.hint': 'Join a workspace with the invite code someone shared with you.',
    ...
    'shell.skip.composer': 'Skip to message box',
    'shell.skip.messages': 'Skip to messages',
    ...
    'onboarding.tips.places': 'The left rail holds your workspaces; the one beside it holds their places.',
    ...
    'switcher.searchMessages': 'Search messages instead',
    'switcher.placeholder': 'Jump to a channel…',
    'switcher.hint': 'Type a channel name, then press Enter.',
