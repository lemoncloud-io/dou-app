...
import { MIN_CHAT_WIDTH, PanelResizeHandle, usePanelWidth } from '../../../shared';
    ...
    return (
        <div className="relative flex h-dvh bg-background">
            ...
            {/* A floor on the conversation itself, not only on each panel: the
                ...
                between them at a narrow desktop window. */}
            <main style={{ minWidth: MIN_CHAT_WIDTH }} className="flex flex-1 flex-col overflow-hidden">
                {main}
            </main>
            {panel}
            {overlay}
