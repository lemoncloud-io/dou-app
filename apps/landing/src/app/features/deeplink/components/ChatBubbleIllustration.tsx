    ...
    return (
        <div className="flex flex-col gap-8 items-center w-full max-w-[375px] px-8">
            ...
            <div className="flex gap-1.5 items-center self-start">
                <div className="relative size-[52px] rounded-full bg-accent/40">
                    <img
                        src={Images.dou1}
                        alt="Character 1"
                ...
                <div className="bg-muted px-3 py-2 rounded-tr-[14px] rounded-br-[14px] rounded-bl-[14px]">
                    <span className="text-foreground text-base font-medium tracking-[-0.288px] leading-[1.28]">
                        Hello!
                    </span>
                </div>
            </div>
            ...
            <div className="flex gap-1.5 items-center self-end -mt-4">
                ...
                <div className="relative size-[52px] rounded-full bg-blue-100 dark:bg-blue-900/30">
                    <img
                        src={Images.dou2}
                        alt="Character 2"
                        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[44px] h-[42px] object-cover"
            ...
            <div className="flex gap-1.5 items-center justify-center">
                ...
                <div className="bg-muted px-3 py-2 rounded-tr-[14px] rounded-br-[14px] rounded-bl-[14px]">
                    <span className="text-foreground text-base font-medium tracking-[1.76px] leading-[1.28]">
                        😊🤝🫶
                    </span>
                </div>
            </div>
