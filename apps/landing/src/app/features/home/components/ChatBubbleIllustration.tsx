        ...
        <div className="relative w-full max-w-[696px] md:max-w-[426px] xl:max-w-[696px] h-[343px] md:h-auto md:aspect-square mx-auto">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                <img
                    src={Logo.logo}
                    alt="DoU mascot"
                    className="w-[130px] h-[123px] md:w-[160px] md:h-[151px] xl:w-[220px] xl:h-[208px] drop-shadow-2xl animate-float"
                />
            </div>
            ...
            <div
                className="absolute top-0 left-[10%] bg-[#F8F8F8]
                           px-[22px] py-3 md:px-8 md:py-4 xl:px-8 xl:py-3
                           ...
                           xl:rounded-bl-[32px] xl:rounded-br-[32px] xl:rounded-tr-[32px] xl:rounded-tl-none
                           shadow-[2px_3px_16px_rgba(0,0,0,0.14)]
                           animate-fade-in-up animate-delay-200"
            >
                <span className="text-[22px] md:text-[28px] xl:text-[36px] font-medium text-[#171725]">Hello!</span>
            </div>
            ...
            <div
                className="absolute top-[10%] right-[5%] bg-navy
                           ...
                           xl:rounded-bl-[32px] xl:rounded-br-[32px] xl:rounded-tl-[32px] xl:rounded-tr-none
                           shadow-[2px_3px_16px_rgba(0,0,0,0.14)]
                           animate-fade-in-up animate-delay-300"
            >
                <span className="text-[22px] md:text-[28px] xl:text-[36px] font-medium text-white">Welcome~</span>
            </div>
            ...
            >
                <span
                    ...
                    className="text-[22px] md:text-[28px] xl:text-[36px] tracking-[5px]"
                >
                    🤝🫶
                </span>
            </div>
