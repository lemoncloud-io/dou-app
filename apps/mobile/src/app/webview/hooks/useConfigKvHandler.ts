...
/**
 * Backs `@chatic/config`'s shell lane (ADR-0079 Decision 9). Unlike `usePreferenceCacheHandler`, this
 ...
 * namespace, which no write can escape: see its docblock, including why "ADR-0080 Decision 13 removed
