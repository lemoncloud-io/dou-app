...
- repository 계약:
    - `libs/data/src/repositories/ChannelRepository.ts` (`createChannel`/`updateChannel`)
    - `libs/data/src/repositories/PlaceRepository.ts` (`createPlace`/`updatePlace`, 타겟 = `id`)
