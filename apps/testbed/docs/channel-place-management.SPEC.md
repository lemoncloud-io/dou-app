...
- repository 계약:
    - [`libs/data/src/repositories-v2/ChannelRepositoryV2.ts`](../../../libs/data/src/repositories-v2/ChannelRepositoryV2.ts) (`createChannel`/`updateChannel`)
    - [`libs/data/src/repositories-v2/PlaceRepositoryV2.ts`](../../../libs/data/src/repositories-v2/PlaceRepositoryV2.ts) (`createPlace`/`updatePlace`, 타겟 = `id`)
