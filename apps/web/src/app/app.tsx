...
import { hasCachedInitData, reportError, useInitWebCore, useTokenRefresh, useWebCoreStore } from '@chatic/web-core';
...
export function App() {
    ...
    const canRenderApp =
        isWebCoreReady &&
        (!isAuthenticated || hasCachedInitData() || (isTokenInitialized && (!!profile || initStatus === 'failed')));
