        ...
        <div className="h-full flex flex-col w-full mx-auto ">
            ...
            <div className="flex-1 flex flex-col px-7 pt-28">
                <div className="flex flex-col items-center gap-2 mb-24">
                    ...
                    <p className="text-sm text-label text-center leading-[1.45] tracking-[0.005em]">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
                    <div className="flex flex-col gap-1.5">
                        ...
                        <Input
                            ...
                            className="h-11 px-3 text-base rounded-[10px] bg-surface border border-input-border leading-[1.45em] tracking-[-0.015em]"
                        />
                    ...
                    {decodedToken && (
                        <div className="flex flex-col gap-2 p-3 bg-secondary rounded-lg">
                            ...
                            <div className="flex flex-col gap-1 text-xs text-label">
