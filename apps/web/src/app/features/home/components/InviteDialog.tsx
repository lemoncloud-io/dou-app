...
import { CloudInviteDialog } from './invite';
 ...
 * 1:1 accept flow and the existing cloud one (REST accept pipeline — ADR-0016). It deliberately
 * calls no data hooks of its own, so a relay link never fires the cloud invite lookup — which is why
 * the branch lives here rather than inside the cloud orchestrator.
 */
