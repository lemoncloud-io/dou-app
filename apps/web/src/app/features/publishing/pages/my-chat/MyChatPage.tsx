    ...
    return (
        <div className="flex flex-col min-h-screen bg-background">
            <header className="fixed top-0 w-full bg-white flex items-center justify-between gap-2 py-3 px-4">
                ...
                <div className="text-base font-medium truncate">내 닉네임으로 노출</div>
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="p-[6px]">
                        ...
                        <DropdownMenuItem
                            ...
                            className="p-1 text-xs text-chatic-text-800"
                        >
                            채팅방 숨김
                        </DropdownMenuItem>
                    </DropdownMenuContent>
            ...
            <div className="flex-1 overflow-y-auto px-4 pb-32 pt-[52px]">
                ...
                <div className="w-full flex items-end justify-end gap-[6px] py-[6px]">
                    <div className="text-[11px] text-chatic-600">오전 10:39</div>
                ...
                <div className="pt-[6px]">
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div className="text-xs flex items-center gap-[2px]">
                            ...
                            <div className="text-chatic-700">나의 에이전트</div>
                        </div>
                    </div>
                    <div className="w-full flex items-end justify-start gap-[6px] py-[6px]">
                        <div className="max-w-[70%] py-[6px] px-3 rounded-xl bg-chatic-primary text-white text-sm">
                ...
                <div className="flex justify-center">
                    <div className="inline-flex py-1 px-2 bg-chatic-700 rounded-[7px] text-white text-[13px] font-medium my-[9px]">
                        2025년 00월 00일 월요일
                    </div>
                </div>
            </div>
