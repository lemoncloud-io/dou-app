...
describe('resolveChannelTitle', () => {
    ...
    // The lineage reads `cid` — the relay cloud vs a subscription one. These cases are the relay
    // lineage unless they say otherwise.
    describe('DM 채널', () => {
    ...
    // so it drops that rung rather than trust it.
