...
jest.mock('@chatic/web-core', () => ({ useRegisterDeviceTokenMutation: jest.fn() }));
...
describe('usePushRegistration — 푸시 서버 등록 확인', () => {
    beforeEach(() => {
        ...
        mockUseDeviceInfo.mockReturnValue({ deviceInfo: { deviceId: 'dev-1', platform: 'ios', installId: 'inst-1' } });
    });
