 ...
 * bridge sync are handled by useTheme's setTheme (`@chatic/config`'s `ui.theme`), so this
 * component only owns the DOM side effect. isDarkTheme already tracks live OS scheme
