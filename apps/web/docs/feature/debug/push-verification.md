...
ready — belongs to `app/bridge/navigation/`; see [bridge/push-navigation.md](../../bridge/push-navigation.md).
...
- [bridge/push-navigation.md](../../bridge/push-navigation.md) — device token registration in
  production, and push tap routing.
