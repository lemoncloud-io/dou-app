...
> 상태: Live · 최종 갱신: 2026-09-07 · 관련 ADR: [[ADR-0074]] (소개 문구 — 정본) · [[ADR-0047]] (0074가 그 `desc` 배제를 취소했다) · [[ADR-0031]] (설정 허브)
...
## 결정 사항 (2026-09-07 기획 확인 — 정본은 ADR-0074)
