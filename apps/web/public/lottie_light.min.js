    ...
    (function (t, e) {
                ...
                return (
                    (o.prototype = {
                        ...
                        createImageData: function (e) {
                            var i = s(e, this.assetsPath, this.path),
                                a = W('image');
                            (u ? this.testImageLoaded(a) : a.addEventListener('load', this._imageLoaded, !1),
                                a.addEventListener(
                                    'error',
                                    function () {
        ...
        (r([G], Q),
            ...
            (Q.prototype.trigger = function (t) {
                ...
                ('enterFrame' === t &&
                    this.onEnterFrame &&
                    this.onEnterFrame.call(this, new x(t, this.currentFrame, this.totalFrames, this.frameMult)),
                    'loopComplete' === t &&
                        this.onLoopComplete &&
                        this.onLoopComplete.call(this, new D(t, this.loop, this.playCount, this.frameMult)),
                    'complete' === t && this.onComplete && this.onComplete.call(this, new w(t, this.frameMult)),
                    'segmentStart' === t &&
                        this.onSegmentStart &&
        ...
        var $ = (function () {
                ...
                function h(t) {
                    for (var i = 0, a = t.target; i < s; )
                        (e[i].animation === a && (e.splice(i, 1), (i -= 1), (s -= 1), a.isPaused || f()), (i += 1));
                }
                function l(t, i) {
                    if (!t) return null;
                    for (var a = 0; a < s; ) {
                    ...
                    (p.prototype = {
                        get: function (t) {
                            ...
                            return (
                                ...
                                e === i && s === a ? t : 0 === t ? 0 : 1 === t ? 1 : h(this._getTForX(t), i, a)
                            );
                        },
                        ...
                        _getTForX: function (t) {
                            for (
                                var e = this._p[0], a = this._p[2], r = this._mSampleValues, n = 0, o = 1, p = i - 1;
                                o !== p && r[o] <= t;
                                ++o
                            )
                                n += s;
        ...
        var rt = (function () {
                ...
                function o(t, e) {
                    ...
                    for (var h = s[r] > n ? -1 : 1, l = !0; l; )
                        if (
                            (s[r] <= n && s[r + 1] > n ? ((o = (n - s[r]) / (s[r + 1] - s[r])), (l = !1)) : (r += h),
                            r < 0 || r >= a - 1)
                        ) {
                            if (r === a - 1) return i[r];
                            l = !1;
                    ...
                    getNewSegment: function (e, i, s, a, r, n, h) {
                        ...
                        for (l = 0; l < m; l += 1)
                            ((p[4 * l] = t.round(1e3 * (g * e[l] + y * s[l] + v * a[l] + b * i[l])) / 1e3),
                                (p[4 * l + 1] = t.round(1e3 * (_ * e[l] + k * s[l] + P * a[l] + A * i[l])) / 1e3),
                                (p[4 * l + 2] = t.round(1e3 * (S * e[l] + x * s[l] + w * a[l] + D * i[l])) / 1e3),
                                (p[4 * l + 3] = t.round(1e3 * (C * e[l] + M * s[l] + T * a[l] + F * i[l])) / 1e3));
                        return p;
                    },
                ...
                if (t >= M || t < T) {
                    ...
                    for (
                        ...
                        if (L >= V && L < V + F.points[d + 1].partialLength) {
                            for (
                                I = (L - V) / F.points[d + 1].partialLength, l = F.points[d].point.length, o = 0;
                                o < l;
                                o += 1
                            )
                                i[o] = F.points[d].point[o] + (F.points[d + 1].point[o] - F.points[d].point[o]) * I;
                            break;
                        }
                        d < f - 1 ? (d += 1) : (y = !1);
                    }
        ...
        function ft(t) {
            ...
            if ('unidimensional' === this.propType)
                ...
                for (var i = 0, s = this.v.length; i < s; )
                    ((e = t[i] * this.mult), ot(this.v[i] - e) > 1e-5 && ((this.v[i] = e), (this._mdf = !0)), (i += 1));
        }
        function dt() {
        ...
        function ut(t, e, i, s) {
            ...
            ((this.propType = 'multidimensional'),
                ...
                (this.frameId = -1));
            var r = e.k.length;
            for (this.v = h('float32', r), this.pv = h('float32', r), this.vel = h('float32', r), a = 0; a < r; a += 1)
        ...
        function yt(t, e, i, s) {
            ...
            ((this._caching = { lastFrame: nt, lastIndex: 0, value: h('float32', f) }), (this.addEffect = mt));
        }
        var vt = {
        ...
        ((kt.prototype.setPathData = function (t, e) {
            ...
            for (var i = 0; i < e; )
                ((this.v[i] = _t.newElement()), (this.o[i] = _t.newElement()), (this.i[i] = _t.newElement()), (i += 1));
        }),
                    ...
                    if (t < m[0].t - this.offsetTime) ((s = m[0].s[0]), (r = !0), (d = 0));
                        ...
                        if (((g = this.keyframesMetadata[y] || {}), (d = y), !(r = 1 === c.h))) {
                            if (t >= u.t - this.offsetTime) p = 1;
                                ...
                                (g.__fnct
                                    ? (_ = g.__fnct)
                                    : ((_ = tt.getBezierEasing(c.o.x, c.o.y, c.i.x, c.i.y).get), (g.__fnct = _)),
                                    (p = _(
                ...
                if (i === e)
                    ...
                    for (a = 0; a < d; a += 1)
                        if ((c = this.shapes[a]).shape._mdf || this._mdf || t || 2 === this.m) {
                            if (((h = (s = c.shape.paths)._length), (f = 0), !c.shape._mdf && c.pathsData.length))
                            ...
                            for (
                                ...
                                ((v = y[o][0]),
                                    ...
                                    b <= 1
                                        ...
                                        : v >= 1
                                          ? g.push({ s: c.totalShapeLength * (v - 1), e: c.totalShapeLength * (b - 1) })
                ...
                for (
                    ...
                    for (h = f[s].lengths, i.c = d[s].c, r = d[s].c ? h.length : h.length + 1, a = 1; a < r; a += 1)
                        if (c + (n = h[a - 1]).addedLength < e.s) ((c += n.addedLength), (i.c = !1));
                            ...
                            (e.s <= c && e.e >= c + n.addedLength
                                ? (this.addSegment(d[s].v[a - 1], d[s].o[a - 1], d[s].i[a], d[s].v[a], i, o, g),
                                  (g = !1))
                                : ((l = rt.getNewSegment(
                                      d[s].v[a - 1],
                                      d[s].v[a],
                    ...
                    if (d[s].c && h.length) {
                        if (((n = h[a - 1]), c <= e.e)) {
                            ...
                            e.s <= c && e.e >= c + y
                                ? (this.addSegment(d[s].v[a - 1], d[s].o[a - 1], d[s].i[0], d[s].v[0], i, o, g),
                                  (g = !1))
                                : ((l = rt.getNewSegment(
                                      d[s].v[a - 1],
                                      d[s].v[0],
        ...
        var Xt = (function () {
            ...
            function e(t, e, i) {
                ...
                (e.sk && ((this.sk = vt.getProp(t, e.sk, 0, P, this)), (this.sa = vt.getProp(t, e.sa, 0, P, this))),
        ...
        function se(t, e, i, s, a, r) {
            ...
            if (
                ((n = t),
                (o = e),
                2 * Math.abs(n.cx - o.cx) < n.width + o.width && 2 * Math.abs(n.cy - o.cy) < n.height + o.height)
            )
        ...
        function ge(t, e, i, s, a) {
            ...
            if (2 === s) {
                var o = -e.tangentAngle(1),
                    ...
                    l = re(r, ne(r, o + Math.PI / 2, 100), n, ne(n, o + Math.PI / 2, 100)),
                    p = l ? oe(l, r) : oe(r, n) / 2,
                    f = ne(r, o, 2 * p * A);
                return (
        ...
        function ve(t, e) {
            ...
            return (
                a && ((i[t.length - 1] = t[t.length - 1].split(a[0])[0]), (s[0] = e[0].split(a[1])[1])),
        ...
        function be(t, e) {
            ...
            if (1 === n.length || Gt(n[1], 1)) return ((i = (a = t.split(n[0]))[0]), (s = a[1]), [ue(i, e), ue(s, e)]);
            i = (a = t.split(n[0]))[0];
            var o = (n[1] - n[0]) / (1 - n[0]);
            return ((r = (a = a[1].split(o))[0]), (s = a[1]), [ue(i, e), ue(r, e), ue(s, e)]);
        }
        function _e() {}
        function ke(t) {
            for (
        ...
        (r([qt], Ht),
            ...
            (Ht.prototype.processShapes = function (t) {
                ...
                if (this._mdf || t) {
                    ...
                    if (d > 0) {
                        ...
                        m &&
                            (this.applyTransforms(this.pMatrix, this.rMatrix, this.sMatrix, this.tr, -m, !0), (_ -= m));
                    }
                    for (
                        ...
                        if (
                            ((b = (i = (e = this.elemsData[s].it)[e.length - 1].transform.mProps.v.props).length),
            ...
            ($t.prototype.split = function (t) {
                ...
                var e = Ut(this.points[0], this.points[1], t),
                    ...
                    r = Ut(i, s, t),
                    n = Ut(a, r, t);
                return [new $t(this.points[0], e, a, n, !0), new $t(n, r, s, this.points[3], !0)];
            }),
            ...
            (_e.prototype.processPath = function (t, e, i, s) {
                ...
                l = (function (t) {
                    ...
                    return (
                        t.length > 1 && ((e = ve(t[t.length - 1], t[0])), (t[t.length - 1] = e[0]), (t[0] = e[1])),
                        t
                    );
                })(l);
                var p = null,
                ...
                for (r = 0; r < l.length; r += 1) {
                    var d = l[r];
                    for (f && (p = ge(a, f, d[0], i, s)), f = d[d.length - 1], n = 0; n < d.length; n += 1)
                        ((o = d[n]),
                            p && he(o.points[0], p)
        ...
        function Be(t, e, i) {
            ...
            ((this.audio = this.globalData.audioController.createAudio(s)),
                ...
                (this.tm = t.tm ? vt.getProp(this, t.tm, 0, e.frameRate, this) : { _placeholder: !0 }),
                (this.lv = vt.getProp(this, t.au && t.au.lv ? t.au.lv : { k: [100] }, 1, 0.01, this)));
        }
        function qe() {}
        (r([bt], Re),
            ...
            (ze.prototype = {
                ...
                initBaseData: function (t, e, i) {
                    ((this.globalData = e),
                        ...
                        (this.effectsManager = new Ve(this.data, this, this.dynamicProperties)));
                },
                getType: function () {
                    return this.type;
                },
        ...
        function Xe(t, e, i) {
            ...
            for (a = 0; a < o; a += 1)
                if (
                    ((('a' !== u[a].mode && 'n' !== u[a].mode) || u[a].inv || 100 !== u[a].o.k || u[a].o.x) &&
                        ((b = 'mask'), (_ = 'mask')),
        ...
        ((We.prototype = {
            initTransform: function () {
                var t = new Ft();
                ((this.finalTransform = {
                    mProp: this.data.ks ? Xt.getTransformProperty(this, this.data.ks, this) : { o: 0 },
                    _matMdf: !1,
                    _localMatMdf: !1,
                    _opMdf: !1,
                    mat: t,
        ...
        function Je(t) {
            ...
            for (this.filters = [], e = 0; e < r; e += 1) {
                ...
                if (Ge[l])
                    ((i = new (0, Ge[l].effect)(o, t.effectsManager.effectElements[e], t, Ke + h, a)),
                        (a = Ke + h),
                        Ge[l].countsAsEffect && (h += 1));
                i && this.filters.push(i);
            }
            (h &&
                (t.globalData.defs.appendChild(o), t.layerElement.setAttribute('filter', 'url(' + s() + '#' + n + ')')),
            ...
            (fi.prototype.setGradientOpacity = function (t, e) {
                if (this.g._hasOpacity && !this.g._collapsable) {
                    ...
                    for (a = 4 * t.g.p; a < r; a += 2)
                        ((i = W('stop')).setAttribute('stop-color', 'rgb(255,255,255)'), p.appendChild(i), f.push(i));
                ...
                function a(i, s, a) {
                    ...
                    for (p = 0; p < u; p += 1) {
                        if (((h = s.sh._mdf || a), s.styles[p].lvl < g)) {
                            for (d = e.reset(), m = g - s.styles[p].lvl, c = s.transformers.length - 1; !h && m > 0; )
                        ...
                        if (((n = (f = s.sh.paths)._length), h)) {
                            for (o = '', r = 0; r < n; r += 1)
                                (l = f.shapes[r]) && l._length && (o += ui(l, l._length, l.c, d));
                            s.caches[p] = o;
                        } else o = s.caches[p];
        ...
        (r([ze, We, Ue, ei, Ze, Oe, Qe], yi),
            ...
            (yi.prototype.addToAnimatedContents = function (t, e) {
                ...
                this.animatedContents.push({ fn: gi.createRenderFunction(t), element: e, data: t });
            }),
            ...
            (yi.prototype.searchShapes = function (t, e, i, s, a, r, n) {
                ...
                for (o = c; o >= 0; o -= 1) {
                    if (
                        ...
                        'tr' === t[o].ty
                            ? (d || (e[o] = this.createTransformElement(t[o], s)), (p = e[o].transform), m.push(p))
                            ...
                            : e >= 55296 && e <= 56319
                              ? Pe.isRegionalFlag(t, a)
                                  ...
                                  : (i = t.charCodeAt(a + 1)) >= 56320 &&
                                    ...
                                    (Pe.isModifier(e, i)
                                        ? ((h = t.substr(a, 2)), (n = !0))
                                        : (h = Pe.isFlagEmoji(t.substr(a, 4)) ? t.substr(a, 4) : t.substr(a, 2)))
                              : e > 56319
                                ? ((i = t.charCodeAt(a + 1)), Pe.isVariationSelector(e) && (n = !0))
            ...
            (bi.prototype.completeTextData = function (t) {
                ...
                for (e = 0; e < i; e += 1)
                    if (
                        ...
                        13 === (P = (T = t.finalText[e]).charCodeAt(0)) || 3 === P
                            ? ((F = 0), g.push(y), (v = y > v ? y : v), (y = -2 * A), (a = ''), (s = !0), (u += 1))
                            : (a = T),
                        h.chars
                        ...
                        ' ' === T ? (F += _ + A) : ((y += _ + A + F), (F = 0)),
                        p.push({ l: _, an: _, add: m, n: s, anIndexes: [], val: a, line: u, animatorJustifyOffset: 0 }),
                        2 == d)
                    ) {
                        if (((m += _), '' === a || ' ' === a || e === i - 1)) {
                            for (('' !== a && ' ' !== a) || (m -= _); c <= e; )
                ...
                for (r = 0; r < n; r += 1) {
                    ...
                    if (1 === E.s.rn)
                        for (e = 0; e < i; e += 1)
                            (N != (I = p[e]).anIndexes[r] &&
                                ((N = I.anIndexes[r]), (O = z.splice(Math.floor(Math.random() * z.length), 1)[0])),
                                (I.anIndexes[r] = O));
                }
                ...
                (s.prototype = {
                    getMult: function (s) {
                        ...
                        var h = tt.getBezierEasing(a, r, n, o).get,
                            ...
                            d = this.data.sh;
                        if (2 === d)
                            l = h((l = f === p ? (s >= f ? 1 : 0) : t(0, e(0.5 / (f - p) + (s - p) / (f - p), 1))));
                        else if (3 === d)
                            ...
                            6 === d
                                ? (f === p
                                  ...
                                  (l = h(l)))
                                : (s >= i(p) && (l = t(0, e(s - p < 0 ? e(f, 1) - (p - s) : f - s, 1))), (l = h(l)));
                        if (100 !== this.sm.v) {
        ...
        ((Pi.prototype.searchProperties = function () {
            var t,
                ...
                s = vt.getProp;
            for (t = 0; t < i; t += 1)
                ((e = this._textData.a[t]), (this._animatorsData[t] = new ki(this._elem, e, this)));
                    ...
                    if (this._hasMaskedPath) {
                        ...
                        if (
                            ...
                            for (
                                ...
                                ((o += c[f].partialLength), (f -= 1) < 0 && (f = (c = u[(d -= 1)].points).length - 1));
                    ...
                    for (a = 0; a < r; a += 1) {
                        if ((S.reset(), (W = 1), D[a].n))
                            ...
                            if (this._hasMaskedPath) {
                                ...
                                (Q !== D[a].ind && (D[Q] && (o += D[Q].extra), (o += D[a].an / 2), (Q = D[a].ind)),
                                    (o += k[0] * D[a].an * 0.005));
                                var ft = 0;
                                for (F = 0; F < E; F += 1)
                                    ((T = P[F].a).p.propType &&
                            ...
                            for (F = 0; F < E; F += 1) {
                                if (
                                    ...
                                    T.r.propType && (L.length ? S.rotateZ(-T.r.v * L[2]) : S.rotateZ(-T.r.v * L)),
                                    T.ry.propType && (L.length ? S.rotateY(T.ry.v * L[1]) : S.rotateY(T.ry.v * L)),
                                    T.rx.propType && (L.length ? S.rotateX(T.rx.v * L[0]) : S.rotateX(T.rx.v * L)),
                                    T.o.propType &&
                                        (L.length ? (W += (T.o.v * L[0] - W) * L[0]) : (W += (T.o.v * L - W) * L)),
                                    t.strokeWidthAnim &&
                                        T.sw.propType &&
                            ...
                            if (
                                ...
                                if (
                                    (S.translate(0, -t.ls), S.translate(0, k[1] * V * 0.01 + s, 0), this._pathData.p.v)
                                ) {
                                ...
                                switch (
                                    (S.translate(i, s, 0), t.ps && S.translate(t.ps[0], t.ps[1] + t.ascent, 0), t.j)
                                ) {
                                    case 1:
                                        S.translate(
                        ...
                        w <= a
                            ...
                            : ((I = this.renderedLetters[a]),
                              (this.lettersChangedFlag = I.update(Z, K, J, U, st, at) || this.lettersChangedFlag));
                    }
                }
            }),
