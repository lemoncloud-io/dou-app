...
| ----------------------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `verify.yml`            | Pull requests, push to `develop` | Doc links, doc language, lint, typecheck & test — only the projects listed as covered; excluded projects are named at the bottom of the file with the reason |
