...
> (`libs/data/src/repositories-v2/index.ts`). 문서가 이름 붙인 `GlobalDataContextStore` /
...
- `libs/data/src/repositories-v2/types.ts`(V1, 이후 삭제됨)와 [libs/data/src/repositories-v2/types.ts](../../../libs/data/src/repositories-v2/types.ts)는 repository가 provider를 통해 최신 context를 읽는 구조를 사용한다.
- [libs/data/src/local/data-sources-v2/types.ts](../../../libs/data/src/local/data-sources-v2/types.ts)는 이미 `contextOverride`를 지원한다.
...
- 대상:
    ...
    - `libs/data/src/local/data-sources-v2/*`
- Definition of done:
