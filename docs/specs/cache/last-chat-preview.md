...
- **리포지토리** — [`ChatRepositoryV2`](../../../libs/data/src/repositories-v2/ChatRepositoryV2.ts): `observeLastList`/`cacheReadLastList` 컨텍스트 패스스루.
